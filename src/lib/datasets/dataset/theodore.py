...
class THEODORE(data.Dataset):
  ...
  def __init__(self, opt, split):
    ...
    self.data_dir = os.path.join("/mnt/data/ndip/", 'theodore')
    ...
    if split == 'test':
      ...
      self.annot_path = os.path.join(
        self.data_dir, 'annotations', 
        'person_keypoints_{}.json').format(split)
    self.max_objs = 32
    ...
    print('==> initializing theodore {} data.'.format(split))
